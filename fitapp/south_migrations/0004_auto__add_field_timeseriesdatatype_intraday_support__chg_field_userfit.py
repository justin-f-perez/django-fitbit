...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'fitapp_timeseriesdata', ['user_id', 'resource_type_id', 'date'])

        # Adding field 'TimeSeriesDataType.intraday_support'
        db.add_column('fitapp_timeseriesdatatype', 'intraday_support',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TimeSeriesDataType.intraday_support'
        db.delete_column('fitapp_timeseriesdatatype', 'intraday_support')
        ...
        db.create_unique(u'fitapp_timeseriesdata', ['user_id', 'resource_type_id', 'date'])
